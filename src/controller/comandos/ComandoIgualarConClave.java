...
public class ComandoIgualarConClave extends ComandoAcciones {
	private UIController controller;
	private FileController fc;

	public ComandoIgualarConClave(UIController controller) {
		super();
		this.nombre = "Igualar con clave [BLOQUEANTE]";
		this.descripcion = "Iguala el fichero base con el incompleto. Añade la clave '#TRADUCIR' a las que falten en el incompleto. Genera un nuevo fichero.";
	...
	public void exec() {
		...
		String pathOutput = FileController.getInstance().getIncomplete() + ".igualadorclave";
		...
		try {
			...
			while ((line = baseReader.readLine()) != null) {
				...
				if (line.equals("") || line.startsWith("#")) {
					...
					if (!existe) {
						outputWriter.write(key + "=#TRADUCIR\n");
						outputWriter.flush();
						System.out.println(
				...
				this.controller.setProgressBar(current);
			}
